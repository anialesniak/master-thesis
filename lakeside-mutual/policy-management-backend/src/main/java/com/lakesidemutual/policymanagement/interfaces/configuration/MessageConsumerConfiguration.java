...
public class MessageConsumerConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, InsuranceQuoteRequestEvent> consumerFactory() {
    ...
    @Bean
    public ConsumerFactory<String, CustomerDecisionEvent> customerDecisionConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, groupId);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, CustomerDecisionEvent> customerDecisionListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CustomerDecisionEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(customerDecisionConsumerFactory());
        return factory;
    }
}
